...
#define mpsDNP   	(shimSet+1)
#define mpsEPR   	(mpsDNP+1)
#define mpsRfOff   	(mpsEPR+1)
#define mpsRfOn   	(mpsRfOff+1)
#define mpsRfExt   	(mpsRfOn+1)
#define mpsPower   	(mpsRfExt+1)
#define mpsFreq   	(mpsPower+1)
#define mpsRxMv   	(mpsFreq+1)
#define mpsLkStat   	(mpsRxMv+1)
#define mpsTemp   	(mpsLkStat+1)
#define mpsAmpStat   	(mpsTemp+1)
#define mpsTxMv   	(mpsAmpStat+1)
