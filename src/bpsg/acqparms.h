...
extern double  sfrq_base;   		/* Transmitter Frequency MHz */
...
extern int HSlines_ptr;	/* offset into code to variable squi */
...
extern int rf500_ptr;	/* offset into code to rf500 variables */
...
extern int tpwrrt;		/* offset to special tpwr */
extern int dhprt;		/* offset to special dhprt */
extern int tphsrt;		/* offset to special tphsrt */
extern int dphsrt;		/* offset to special dphsrt */

extern int ntrt;		/* offset into code to nt for vscan elem. */
extern int dlvlrt;		/* offset to special dlvlrt */

extern int hwloop_ptr;	/* offset to hardware loop Acode */
extern int multhwlp_ptr;	/* offset to multiple hardware loop flag */
extern int nsc_ptr;		/* offset to NSC Acode */
